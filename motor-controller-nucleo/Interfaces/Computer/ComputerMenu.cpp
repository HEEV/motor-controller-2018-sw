...
ComputerMenu::ComputerMenu(ComputerInterface *ci)
{
  ...
  hall_setting_items[0] = MenuItem{"Up", "", default_param, &main_menu_items[2], 1};
  ...
  pi_menu_items[0] = MenuItem{"Up", "", default_param, &main_menu_items[2], 1}; 
  pi_menu_items[1] = MenuItem{"Torque P constant", "", mc_param::TORQUE_P, nullptr, 0};
  pi_menu_items[2] = MenuItem{"Torque I constant", "", mc_param::TORQUE_I, nullptr, 0};
  pi_menu_items[3] = MenuItem{"Velocity P constant", "", mc_param::VELOCITY_P, nullptr, 0};
  pi_menu_items[4] = MenuItem{"Velocity I constant", "", mc_param::VELOCITY_I, nullptr, 0};
  pi_menu_items[5] = MenuItem{"Flux P constant", "", mc_param::FLUX_P, nullptr, 0};
  pi_menu_items[6] = MenuItem{"Flux I constant", "", mc_param::FLUX_I, nullptr, 0};

  open_loop_items[0] = MenuItem{"Up", "", default_param, &main_menu_items[1], 1};
  ...
  motor_setting_items[3] = MenuItem{"PI constants", "", default_param, pi_menu_items.data(), pi_menu_items.size()};
  motor_setting_items[4] = MenuItem{"Open Loop Settings", "", default_param, open_loop_items.data(), open_loop_items.size()};
  motor_setting_items[5] = MenuItem{"Hall Effect Settings", "", default_param, 
                                    hall_setting_items.data(), hall_setting_items.size()};
  motor_setting_items[6] = MenuItem{"Hall Effect Auto Setup", "", mc_param::HALL_AUTO_SETUP, nullptr, 0};
  ...
  general_setting_items[3] = MenuItem{"Motor Controller CAN ID", "", mc_param::CONTROLLER_CAN_ID, nullptr, 0};
  general_setting_items[4] = MenuItem{"Throttle CAN ID", "", mc_param::THROTTLE_CAN_ID, nullptr, 0};
